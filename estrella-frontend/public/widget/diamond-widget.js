(function () {
  ...
  var SHAPE_SVGS = {
    round:    '<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"><circle cx="50" cy="50" r="36" fill="none" stroke="currentColor" stroke-width="1.4"/><path d="M14 50 L86 50 M50 14 L50 86 M24.6 24.6 L75.4 75.4 M75.4 24.6 L24.6 75.4" stroke="currentColor" stroke-width="0.6" opacity="0.85"/></svg>',
    oval:     '<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"><ellipse cx="50" cy="50" rx="26" ry="38" fill="none" stroke="currentColor" stroke-width="1.4"/><path d="M50 12 L50 88 M30 30 L70 70 M70 30 L30 70" stroke="currentColor" stroke-width="0.6" opacity="0.85"/></svg>',
    princess: '<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"><rect x="18" y="18" width="64" height="64" fill="none" stroke="currentColor" stroke-width="1.4"/><path d="M18 18 L82 82 M82 18 L18 82 M50 18 L50 82 M18 50 L82 50" stroke="currentColor" stroke-width="0.6" opacity="0.85"/></svg>',
    cushion:  '<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"><rect x="18" y="18" width="64" height="64" rx="14" ry="14" fill="none" stroke="currentColor" stroke-width="1.4"/><path d="M28 28 L72 72 M72 28 L28 72 M50 18 L50 82 M18 50 L82 50" stroke="currentColor" stroke-width="0.6" opacity="0.85"/></svg>',
    emerald:  '<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"><path d="M30 16 L70 16 L84 30 L84 70 L70 84 L30 84 L16 70 L16 30 Z" fill="none" stroke="currentColor" stroke-width="1.4"/><path d="M28 28 L72 28 M28 72 L72 72 M28 28 L28 72 M72 28 L72 72 M50 16 L50 84" stroke="currentColor" stroke-width="0.6" opacity="0.85"/></svg>',
  ...
  var LAB_SEALS = {
    ...
    generic: '<svg viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">' +
               ...
               '<polygon points="22,12 32,16 32,28 22,32 12,28 12,16" stroke="currentColor" stroke-width="0.6" fill="none" opacity="0.85"/>' +
             '</svg>'
  };
